...
export default function LoginPage({ onNavigate, onLogin }: LoginPageProps) {
  ...
  const handleGoogleLogin = () => {
    ...
    if (clientId) {
      ...
      window.open(authUrl, "Google Sign-In", `width=${width},height=${height},top=${top},left=${left}`);
        ...
        <div className="w-full max-w-md">
          ...
          <div className="grid grid-cols-2 gap-3 mb-6">
            <button
              ...
              className="flex items-center justify-center gap-2 py-2.5 px-4 border border-slate-200 dark:border-slate-700 rounded-lg bg-white dark:bg-slate-900 hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-300 text-sm font-medium transition-colors"
            >
