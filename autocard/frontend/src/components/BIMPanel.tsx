...
export default function BIMPanel({ element, onUpdate, onClose }: { element: any; onUpdate: (id: string, data: any) => void; onClose: () => void }) {
  ...
  const updateBim = (key: string, value: any) => {
    onUpdate(element.id, {
      bim: { ...bim, [key]: value },
    });
  };
